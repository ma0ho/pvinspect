...
def test_calibrate_flatfield_linear():
    ...
    coeff_result = calibrate_flatfield(_make_image_seq([img0, img1]), [0, 1.0])
...
def test_calibrate_flatfield_quadratic():
    ...
    coeff = calibrate_flatfield(_make_image_seq([img0, img1, img2]), [0, 0.5, 1.0])
...
def test_calibrate_flatfield_least_squares_linear():
    ...
    coeff_result = calibrate_flatfield(_make_image_seq([img0, img1, img2]), [0, 0.5, 1.0], order=1)
...
def test_compensate_flatfield():
    ...
    res = compensate_flatfield(_make_image_seq([img]), coeff)[0].data
...
def test_calibrate_and_compensate_flatfield():
    ...
    coeff = calibrate_flatfield(_make_image_seq([img0, img1, img2]), [0, 0.5, 1.0])
    compensated = compensate_flatfield(_make_image_seq([img0, img1, img2]), coeff)
